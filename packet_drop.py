...
class PacketDropSimulator(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        # Drop rule: drop all packets from drop_ip (higher priority)
        match_drop = parser.OFPMatch(eth_type=0x0800,
                                     ipv4_src=self.drop_ip)
        self.add_flow(datapath, 10, match_drop, [])  # empty actions = drop
